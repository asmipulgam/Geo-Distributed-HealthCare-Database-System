...
CMD = [
    "docker run -d --name roach-seattle-1  -p 26257:26257 -p 8080:8080 -v roach1-data:/cockroach/cockroach-data cockroachdb/cockroach start-single-node --insecure --accept-sql-without-tls",

    "docker run -d --name roach-seattle-2  -p 26258:26257 -p 8081:8080 -v roach1-data:/cockroach/cockroach-data cockroachdb/cockroach start-single-node --insecure --accept-sql-without-tls",


    "docker run -d --name roach-newyork-1  -p 26259:26257 -p 8082:8080 -v roach1-data:/cockroach/cockroach-data cockroachdb/cockroach start-single-node --insecure --accept-sql-without-tls",

    "docker run -d --name roach-newyork-2  -p 26260:26257 -p 8083:8080 -v roach1-data:/cockroach/cockroach-data cockroachdb/cockroach start-single-node --insecure --accept-sql-without-tls",

    "docker run -d --name roach-omaha-1  -p 26261:26257 -p 8084:8080 -v roach1-data:/cockroach/cockroach-data cockroachdb/cockroach start-single-node --insecure --accept-sql-without-tls",

    "docker run -d --name roach-omaha-2  -p 26262:26257 -p 8085:8080 -v roach1-data:/cockroach/cockroach-data cockroachdb/cockroach start-single-node --insecure --accept-sql-without-tls"
