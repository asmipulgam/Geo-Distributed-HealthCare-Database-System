...
0) Ensure you have Python 3.x, Node.js (We have run on v22), and npm installed on your system.
...
5) Run the command: `npm install` - This will install all the dependencies required for the frontend ReactJS application. We havce included the node_modules folder in code submission for easy use. But in case there is an error, Please run npm uninstall and npm install repeatedly. Should resolve any issues.
